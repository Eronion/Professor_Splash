...
//Sensori di distanza
#define trigPin1 13 //Il sensore di distanza 1 vede se c'è una palla disponibile da far entrare nella macchina 
#define echoPin1 12
#define trigPin2 15 //Il sensore 2 cerca di capire quando un pallone entra nel canestro
#define echoPin2 14
#define trigPin3 16 //Il 3 misura la distanza del tiratore per capire se il tiro è da considerare da 2 o 3pt.
#define echoPin3 17
...
void loop() {
    ...
    if (iState==4){
		 ...
		 delay(500);
		 //conto tirati
		 if(distance_posizioneTiro<75) tirati_2punti=tirati_2punti+1;
		 else tirati_3punti=tirati_3punti+1;
		 iImposed=1;
	}
	...
	//dopo che passo ultimo passaggio torno in zero aspetto qualche secondo il canestro e poi azzero le stat
		...
		if(distance_realizzati < 15){
			if(distance_posizioneTiro<75) realizzati_2punti=realizzati_2punti+1;
		    else realizzati_3punti=realizzati_3punti+1;
		}
